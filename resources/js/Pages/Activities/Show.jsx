            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2 space-y-6">
                    <div className="bg-card p-8 rounded-lg shadow-sm border border-border">
                        ...
                        <div className="space-y-8">
                            <div>
                                <h3 className="text-lg font-semibold mb-2 text-foreground">Activity Notes</h3>
                                ...
                                <div>
                                    ...
                                    {activity.data.contact_id ? (
                                        ...
                                        >
                                            ...
                                            <div>
                                                <p className="font-semibold text-foreground group-hover:text-blue-600">{activity.data.contact_fullname}</p>
                                ...
                                <div>
                                    ...
                                    {activity.data.lead_id ? (
                                        ...
                                        >
                                            ...
                                            <div>
                                                <p className="font-semibold text-foreground group-hover:text-blue-600">{activity.data.lead_description}</p>
                ...
                <div className="space-y-6">
                    <div className="bg-card p-6 rounded-lg shadow-sm border border-border">
                        <h3 className="text-lg font-semibold mb-4 text-foreground border-b pb-2">Activity Info</h3>
...
Show.layout = (page) => (
    <Layout>
        <ResourceLayout children={page} title={`Activity Details`} hideHeader={true} />
    </Layout>
);
