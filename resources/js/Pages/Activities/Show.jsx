        ...
        <div className="space-y-6 max-w-5xl mx-auto">
            <div className="flex items-center justify-between">
                <Button variant="ghost" asChild className="pl-0 hover:bg-transparent">
                    <Link href={route("activities.index")} className="flex items-center text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                        <div className="flex items-start justify-between mb-8 border-b pb-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white capitalize">{activity.data.type} Activity</h1>
                        ...
                        <div className="space-y-8">
                            <div>
                                <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">Activity Notes</h3>
                                <p className="text-gray-600 dark:text-gray-300 leading-relaxed whitespace-pre-wrap bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-100 dark:border-gray-800">
                                    {activity.data.description || "No notes provided."}
                                </p>
                            </div>

                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-6 border-t border-gray-100 dark:border-gray-700">
                                <div>
                                    <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">Contact Involved</h3>
                                    {activity.data.contact_id ? (
                                        ...
                                        >
                                            ...
                                            <div>
                                                <p className="font-semibold text-gray-900 dark:text-white group-hover:text-blue-600">{activity.data.contact_fullname}</p>
                                ...
                                <div>
                                    <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">Related Lead</h3>
                                    {activity.data.lead_id ? (
                                        ...
                                        >
                                            ...
                                            <div>
                                                <p className="font-semibold text-gray-900 dark:text-white group-hover:text-blue-600">{activity.data.lead_description}</p>
                                                <p className="text-sm text-gray-500">View lead details</p>
                                            </div>
                                        </Link>
                                    ) : (
                                        <p className="text-gray-500 italic">No lead linked</p>
                                    )}
                                </div>
                            </div>
                        </div>
                ...
                <div className="space-y-6">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                        <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white border-b pb-2">Activity Info</h3>
                        <dl className="space-y-4">
                            <div>
                                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Type</dt>
                                <dd className="text-base font-semibold text-gray-900 dark:text-white mt-1 capitalize">{activity.data.type}</dd>
                            </div>
                            <div>
...
Show.layout = (page) => (
    <Layout>
        <ResouceLayout children={page} title={`Activity Details`} />
    </Layout>
);
