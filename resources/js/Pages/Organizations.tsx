...
const OrganizationCard = ({ membership }) => {
    ...
    const isSelected =
        auth.organization && auth.organization.id === organization.id;
    ...
    return (
        <Card
            className={cn(
                ...
                isSelected &&
                    "ring-2 ring-blue-500 border-blue-500/50 shadow-blue-500/10",
            )}
        >
            <CardHeader className="pb-4">
                <div className="flex justify-between items-start">
                    ...
                    {isSelected && (
                        <Badge
                            variant="default"
                            className="bg-blue-600 text-white animate-in fade-in zoom-in duration-300"
                        >
                            Active
                        </Badge>
                    )}
                ...
                <div className="mt-4">
                    ...
                    <div className="flex items-center mt-1 text-sm text-muted-foreground">
                        {isOwner ? (
                            <Badge
                                variant="outline"
                                className="text-[10px] uppercase tracking-wider py-0 px-2 h-5 border-yellow-500/50 text-yellow-600 bg-yellow-500/5"
                            >
                            ...
                            <Badge
                                variant="outline"
                                className="text-[10px] uppercase tracking-wider py-0 px-2 h-5 border-blue-500/50 text-blue-600 bg-blue-500/5"
                            >
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                            ...
                            <span className="font-medium text-foreground">
                                {invitation.organization.user.username}
                            </span>
                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            <div className="h-8 w-8 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-blue-500/20">
                                N
                            </div>
                            <span className="text-sm font-bold uppercase tracking-[0.2em] text-blue-600/70">
                                Nexus CRM
                            </span>
                        </div>
                        ...
                        <p className="mt-3 text-lg text-muted-foreground max-w-lg">
                            Choose an organization to start managing your deals
                            and contacts.
                        </p>
                    </div>
                ...
                {invitations.length > 0 && (
                    <div className="mb-12 animate-in slide-in-from-top-4 duration-500">
                        <div className="flex items-center gap-3 mb-4">
                            <h2 className="text-xs font-bold uppercase tracking-widest text-blue-600/80">
                                Pending Invitations
                            </h2>
                        ...
                        <Card className="border-dashed py-20 bg-muted/30">
                            <div className="flex flex-col items-center justify-center text-center px-4">
                                ...
                                <p className="text-muted-foreground max-w-sm mb-8">
                                    ...
                                    organization to manage your business.
                                </p>
                                <CreateOrganizationModal />
                            </div>
                        </Card>
