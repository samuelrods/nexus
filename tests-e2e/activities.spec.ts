...
test.describe("Activities", () => {
    ...
    test("log a call activity", async ({ page }) => {
        ...
        await expect(page.getByTestId("activity-type-label")).toHaveText(
            "call",
        );
    });
