...
test.describe("Empty States", () => {
    test("companies list shows empty state when no results match search", async ({
        page,
    }) => {
    ...
    test("contacts list shows empty state when no results match search", async ({
        page,
    }) => {
    ...
    test("leads list shows empty state when no results match search", async ({
        page,
    }) => {
